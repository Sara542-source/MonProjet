...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        HikariConfig config = new HikariConfig(); //Configure HikariCP (pool de connexions performant).
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.jetbrains.ebankingapp3.model");
